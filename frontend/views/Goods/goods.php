            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$model->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$model->logo?>" height="260" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            ...
                            <li >
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://www.adminyii.com<?=$p->path?>',largeimage: 'http://www.adminyii.com<?=$p->path?>'}"><img src="http://www.adminyii.com<?=$p->path?>"></a>
                            </li>
                            <?php endforeach;?>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    ...
                    <div class="desc mt10">
                        ...
                        <img src="http://www.adminyii.com<?=$a->path?>" alt="" />
